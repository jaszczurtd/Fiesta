...
#define CAN_RPM_HEARTBEAT_INTERVAL_MS 100u
#define CAN_RPM_RETRY_INTERVAL_MS 10u

/* All project-owned standard IDs fit in 0x120..0x13F. */
#define CAN_FIESTA_STD_ID_BASE 0x120u
#define CAN_FIESTA_STD_ID_MASK 0x7E0u
...
enum {
  ...
  CAN_FRAME_GPS_EXT_DT_HI, // packed datetime: YYYY offset from 2020 (4b), MM
                           // (4b), DD (5b), HH (5b), mm (6b)
...
enum {
  CAN_FRAME_RTC_UPDATE_DT_HI = 1, // packed datetime: YYYY offset from 2020
                                  // (4b), MM (4b), DD (5b), HH (5b), mm (6b)
