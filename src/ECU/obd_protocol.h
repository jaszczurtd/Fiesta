#ifndef ECU_OBD_PROTOCOL_H
#define ECU_OBD_PROTOCOL_H
...
// If changing ecu_PartNumber, update these bytes to match the new middle
// section.
...
#define DID_FORD_PARTNUM_MIDDLE                                                \
  0xE217 // binary middle  (e.g. 12A650->0x120A0650)
...
#define DID_FORD_BOOST_DESIRED                                                 \
  0xDD07 // Desired boost pressure (2 bytes, bar ×1000)
