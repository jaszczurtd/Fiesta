...
void test_no_i2c_red_green_cycle(void) {
  ...
  bool has_green =
      (first == HAL_RGB_LED_GREEN) || (second == HAL_RGB_LED_GREEN);
...
void test_fuel_broken_purple_green_cycle(void) {
  ...
  bool has_purple =
      (first == HAL_RGB_LED_PURPLE) || (second == HAL_RGB_LED_PURPLE);
  bool has_green =
      (first == HAL_RGB_LED_GREEN) || (second == HAL_RGB_LED_GREEN);
...
void test_both_faults_three_color_cycle(void) {
  ...
  bool has_purple = (c1 == HAL_RGB_LED_PURPLE) || (c2 == HAL_RGB_LED_PURPLE) ||
                    (c3 == HAL_RGB_LED_PURPLE);
  bool has_red = (c1 == HAL_RGB_LED_RED) || (c2 == HAL_RGB_LED_RED) ||
                 (c3 == HAL_RGB_LED_RED);
  bool has_green = (c1 == HAL_RGB_LED_GREEN) || (c2 == HAL_RGB_LED_GREEN) ||
                   (c3 == HAL_RGB_LED_GREEN);
  TEST_ASSERT_TRUE(has_purple);
  TEST_ASSERT_TRUE(has_red);
  TEST_ASSERT_TRUE(has_green);
}
...
void test_voltage_bad_yellow_green_cycle(void) {
  ...
  bool has_yellow =
      (first == HAL_RGB_LED_YELLOW) || (second == HAL_RGB_LED_YELLOW);
  bool has_green =
      (first == HAL_RGB_LED_GREEN) || (second == HAL_RGB_LED_GREEN);
