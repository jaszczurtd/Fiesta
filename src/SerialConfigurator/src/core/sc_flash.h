 ...
 * blocks. Each block's payload bytes are NOT checked because only the
 * artifact's structural properties are validated here.
 *
...
/**
 * @brief Test-only entry point: behaves like
